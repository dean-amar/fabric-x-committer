...
type AuthEnvelopeParams struct {
	...
	// obtained from IssueNonce, to a value the server never issued, or to nil to omit it entirely.
	Nonce []byte
}
...
func BuildAuthEnvelopeForTest(params *AuthEnvelopeParams) (*common.Envelope, error) {
