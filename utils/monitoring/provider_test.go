...
func TestCounter(t *testing.T) {
	...
	promutil.CheckMetrics(t, env.provider.url, "vcservice_committed_transaction_total 2")

	promutil.AddToCounter(c, 10)
	promutil.CheckMetrics(t, env.provider.url, "vcservice_committed_transaction_total 12")
}
...
func TestNewGuage(t *testing.T) {
	...
	g.Add(10)
	promutil.CheckMetrics(t, env.provider.url, "vcservice_preparer_transactions_queued 10")

	g.Sub(3)
	promutil.CheckMetrics(t, env.provider.url, "vcservice_preparer_transactions_queued 7")

	promutil.SetGauge(g, 5)
	promutil.CheckMetrics(t, env.provider.url, "vcservice_preparer_transactions_queued 5")
}
